...
\begin{enumerate}
  ...
  \item Theoretische Grundlagen
    \begin{enumerate}
      ...
      \item \acs{UI}-basierte \ac{RPA}: Technologie und Funktionsweise
      \item Eignung von Geschäftsprozessen für \ac{RPA}
      \item \acs{API}-lose Legacy-Systeme: Charakteristika und Integrationsherausforderungen
    \end{enumerate}

  \item Forschungsstand und verwandte Arbeiten
    \begin{enumerate}
      \item Bestehende Vorgehensmodelle zur \acs{RPA}-Implementierung
      \item \ac{RPA} in Legacy-Umgebungen: bisherige Ansätze und Lücken
  ...
  \item Entwicklung des Vorgehensmodells
    \begin{enumerate}
      ...
      \item Besonderheiten des \acs{UI}-\acs{RPA}-Einsatzes in \acs{API}-losen Umgebungen
    \end{enumerate}
